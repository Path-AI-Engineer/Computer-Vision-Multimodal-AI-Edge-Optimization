...
$repository = "plan-04/p20-shelf-detection-console"
...
if ($LASTEXITCODE -ne 0) {
    & $aws ecr create-repository @awsCommon `
        ...
        --tags Key=Path,Value=ai-engineer Key=Plan,Value=04 Key=Project,Value=20 *> $null
...
& $aws cloudformation deploy @awsCommon `
    ...
    --tags Path=ai-engineer Plan=04 Project=20 Environment=portfolio
