...
$repository = "plan-04/p21-surface-quality-control"
$service = "ai-04-p21-surface-quality-control"
$stack = $service
...
if ($LASTEXITCODE -ne 0) {
    & $aws ecr create-repository @awsCommon `
        ...
        --tags Key=Path,Value=ai-engineer Key=Plan,Value=04 Key=Project,Value=21 *> $null
...
& $aws cloudformation deploy @awsCommon `
    ...
    --tags Path=ai-engineer Plan=04 Project=21 Environment=portfolio
